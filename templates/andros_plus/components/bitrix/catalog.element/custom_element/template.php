...
$this->addExternalJS(SITE_TEMPLATE_PATH . "/js/morpher.min.js");
...
<div class="section section--breadcrumbs">
	<div class="breadcrumbs">
		...
		<? if ($arResult['SECTION']['PATH'][0]) : ?>
			<div class="breadcrumbs__item">
				<a href="<?= $arResult['SECTION']['PATH'][0]['SECTION_PAGE_URL'] ?>" class="breadcrumbs__item_link">
		...
		<? if ($arResult['SECTION']['PATH'][1]) : ?>
			<div class="breadcrumbs__item">
				<a href="<?= $arResult['SECTION']['PATH'][1]['SECTION_PAGE_URL'] ?>" class="breadcrumbs__item_link">
...
<div class="page page--static">
	...
	<div class="page__content">
		...
		<div class="page__submenu">
			<div class="section section--submenu">
				<div class="container ">
					<div class="r_box">
						<div class="nav">
							<div class="nav__item" data-scroll="section--text-with-media">
								Описание
							</div>
							<div class="nav__item" data-scroll="section--links">
								Показания и проблемы
							</div>
							<div class="nav__item" data-scroll="section--before-after">
								До / После
							</div>
							<div class="nav__item" data-scroll="section--prices">
								Цены
							</div>
							<div class="nav__item" data-scroll="section--specialists">
								Специальсты
							</div>
						</div>
					</div>
		...
		<div class="section section--text-with-media section--toggle">
			<div class="section__content">
				<div class="r_textblock">
					<div class="r_textblock__col r_textblock__col--media">
						<div class="r_textblock__title" data-toggle-title>
							<h3><?= $arResult['PROPERTIES']['TITLE_DESCRIPTION_1']['VALUE'] ?></h3>
						</div>
						<div class="r_textblock__media" data-toggle-content>
							<div class="r_thumbitem r_thumbitem--image">
								<picture>
									<source data-srcset="<?= CFile::GetPath($arResult['PROPERTIES']['FOTO_DESCRIPTION_1']['VALUE']) ?>" srcset="<?= SITE_TEMPLATE_PATH ?>/assets/blank.png" type="image/webp">
									<img class="lazyload" src="<?= SITE_TEMPLATE_PATH ?>/assets/blank.png" data-src="<?= CFile::GetPath($arResult['PROPERTIES']['FOTO_DESCRIPTION_1']['VALUE']) ?>" alt>
								</picture>
							</div>
						</div>
					</div>
					<div class="r_textblock__col r_textblock__col--text" data-toggle-content>
						<div class="editor">
							<?= htmlspecialcharsback($arResult['PROPERTIES']['TEXT_DESCRIPTION_1']['VALUE']['TEXT']) ?>
						</div>
					</div>
				</div>
			</div>
		</div>
		<!--section text-with-media END-->


		<!--section benefits-->
		<div class="section section--benefits section--benefits-plastic js-benefits-plastic-carousel">
			<div class="benefits">
				<div class="swiper">
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<div class="benefits__item">
								<div class="h3"><?= $arResult['PROPERTIES']['TITLE_ADVANTAGE_1']['VALUE'] ?></div>
								<p><?= $arResult['PROPERTIES']['TEXT_ADVANTAGE_1']['VALUE'] ?></p>
							</div>
						</div>
						<div class="swiper-slide">
							<div class="benefits__item">
								<div class="h3"><?= $arResult['PROPERTIES']['TITLE_ADVANTAGE_2']['VALUE'] ?></div>
								<p><?= $arResult['PROPERTIES']['TEXT_ADVANTAGE_2']['VALUE'] ?></p>
							</div>
						</div>
						<div class="swiper-slide">
							<div class="benefits__item">
								<div class="h3"><?= $arResult['PROPERTIES']['TITLE_ADVANTAGE_2']['VALUE'] ?></div>
								<p><?= $arResult['PROPERTIES']['TEXT_ADVANTAGE_3']['VALUE'] ?></p>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="section section--text-with-media section--toggle">
			<div class="section__content">
				<div class="r_textblock">
					<div class="r_textblock__col r_textblock__col--media">
						<div class="r_textblock__title" data-toggle-title>
							<h3><?= $arResult['PROPERTIES']['TITLE_DESCRIPTION_2']['VALUE'] ?></h3>
						</div>
						<div class="r_textblock__media" data-toggle-content>

							<a href="https://www.youtube.com/<?= $arResult['PROPERTIES']['VIDEO_DESCRIPTION_2']['VALUE'] ?>" data-fancybox="video" class="r_thumbitem r_thumbitem--video">

								<picture>
									<source data-srcset="<?= CFile::GetPath($arResult['PROPERTIES']['FOTO_DESCRIPTION_2']['VALUE']) ?>" srcset="<?= SITE_TEMPLATE_PATH ?>/assets/blank.png" type="image/webp">
									<img class="lazyload card__image_src" src="<?= SITE_TEMPLATE_PATH ?>/assets/blank.png" data-src="<?= CFile::GetPath($arResult['PROPERTIES']['FOTO_DESCRIPTION_2']['VALUE']) ?>" alt>
								</picture>
							</a>

							<p class="text-small"><?= $arResult['PROPERTIES']['SUB_VIDEO_DESCRIPTION_2']['VALUE'] ?></p>
						</div>
					</div>
					<div class="r_textblock__col r_textblock__col--text" data-toggle-content>
						<div class="editor">
							...
							<ol>
								<li>Консультация: Процесс начинается с консультации у квалифицированного врача или косметолога. На этом этапе пациент обсуждает свои желания и цели, а также проходит оценку состояния кожи. Врач проводит диагностику и определяет, какие области требуют коррекции.</li>

								<li>Выбор филлера: В зависимости от целей и характеристик пациента, врач выбирает подходящий филлер. Гиалуроновая кислота – один из самых популярных составляющих филлеров, так как она хорошо взаимодействует с кожей и обеспечивает естественный результат.</li>

								<li>Подготовка: Перед проведением процедуры врач может предложить пациенту использовать местный анестетик или анестезирующий крем, чтобы уменьшить дискомфорт от инъекций.</li>

								<li>Инъекции филлера: Врач использует специальные инъекционные иглы или канюли для введения филлера в определенные области кожи. Эти области могут включать губы, щеки, подбородок, скулы, морщины и другие зоны, подлежащие коррекции. Врач работает аккуратно, учитывая анатомию лица, чтобы достичь желаемых результатов.</li>

								<li>Массаж и моделирование: После инъекций врач может провести массаж и моделирование области, чтобы равномерно распределить филлер и достичь оптимальных контуров. Это помогает предотвратить несимметричность и обеспечить естественный результат.</li>
							</ol>
							<p>Эффект и результат: Эффект от контурной пластики становится видимым практически сразу после процедуры и продолжает улучшаться в течение нескольких недель. Результаты обычно долгосрочные, но могут потребовать периодических повторных процедур для поддержания.</p>
				...
				<div class="r_box">
					...
					<div class="section__content">
						<ul class="nav nav--arrows">
							<? foreach ($arResult['PROPERTIES']['PROBLEM_AREA']['VALUE'] as $area) : ?>
								<li class="nav__item">
									<a href="/catalog/problem-area/?area=<?= $area ?>" class="nav__item_link"><?= $area ?></a>
								</li>
							<? endforeach ?>
						</ul>
					</div>
		...
		<div class="section section--before-after js-beforeafter-carousel">
			<div class="section__header">
				<div class="section__header_title">
					<h3>До / После</h3>
				</div>
			...
			<div class="section__content">
				...
				<div class="r_carousel r_carousel--brefore-after">
					<div class="swiper">
						<div class="swiper-wrapper">
							<? foreach ($arResult['PROPERTIES']['BERFORE_AFTER_FOTO']['VALUE'] as $foto) : ?>
								<div class="swiper-slide">
									<div class="item">
										<img class="lazyload item__src" src="<?= SITE_TEMPLATE_PATH ?>/assets/blank.png" data-src="<?= CFile::GetPath($foto) ?>" alt='<?= $foto ?>'>
									</div>
								</div>
							<? endforeach ?>
						</div>
		...
		<div class="section section--prices">
			<div class="section__header">
				<div class="section__header_title">
					<h3>Цена <?= $arResult['PROPERTIES']['PRICE_TITLE_NAME']['VALUE'] ?> в Ессентуках</h3>
				</div>
			</div>
			<div class="section__content">
				<div class="editor">
					...
					<div class="r_table r_table--prices">
						<div class="r_table__inner">
							<div class="items">
								<div class="item">
									<div class="item__col item__col--code">
										А11.01.013
									</div>
									<div class="item__col item__col--name">
										<a href="index.html">RADIESSE, 1.5 мл.</a>
									</div>
									<div class="item__col item__col--prices">
										<div class="prices">
											<div class="price price--old">39 000 руб.</div>
											<div class="price price--default">29 000 руб.</div>
										</div>
									</div>
								</div>
								<div class="item">
			...
			<div class="section__footer">
				<button class="btn btn--bordered size--lg" onclick="popupApp.open('appointment');">Записаться</button>
			</div>
		</div>
